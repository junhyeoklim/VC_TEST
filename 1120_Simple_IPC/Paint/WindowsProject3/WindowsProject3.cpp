    ...
    case WM_COMMAND:
        {
            ...
            case ID_DRAWLINE:
                g_kind = 1;
                PostMessage(g_you, WM_USER + 3, 0, 0);
                break;
            case ID_DRAWRECT:
                g_kind = 2;
                PostMessage(g_you, WM_USER + 4, 0, 0);
                break;
            case ID_DRAWELLIPS:
                g_kind = 3;
                PostMessage(g_you, WM_USER + 5, 0, 0);
                break;
            case ID_DRAWFREELINE:
                g_kind = 4;
                PostMessage(g_you, WM_USER + 6, 0, 0);
                break;
            case ID_LINETYPE1:
                g_LineSource = 1;
                PostMessage(g_you, WM_USER + 12, 0, 0);
                    break;
            case ID_LINETYPE2:
                g_LineSource = 2;
                PostMessage(g_you, WM_USER + 13, 0, 0);
                    break;
            case ID_RED:
                g_color = 1;
                PostMessage(g_you, WM_USER + 0, 0, 0);
                break;
            case ID_BLACK:
                g_color = 2;
                PostMessage(g_you, WM_USER + 1, 0, 0);
                break;
            case ID_BLUE:
                g_color = 3;
                PostMessage(g_you, WM_USER + 2, 0, 0);
                break;
            case ID_SIZE1:
                g_size = 1;
                PostMessage(g_you, WM_USER + 7, 0, 0);
                break;
            case ID_SIZE2:
                g_size = 2;
            ...
            case ID_SIZE3:
                g_size = 3;
                PostMessage(g_you, WM_USER + 9, 0, 0);
                break;
            case ID_SIZE4:
                g_size = 4;
                PostMessage(g_you, WM_USER + 10, 0, 0);
                break;
            case ID_SIZE5:
                g_size = 5;
                PostMessage(g_you, WM_USER + 11, 0, 0);
                break;
            default:
